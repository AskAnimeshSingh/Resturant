...
<script>
                ...
                success: function(data) {
                    ...
                    if (data.products.length > 0) {
                        $.each(data.products, function(i, val) {
                            ...
                            datas += '<div class="col-xl-4 col-lg-6 col-md-12" style="width: 15rem;" >' +
                                '<div class="card card-menu mb-3">' +
                                '<div class="card-body">' +
                                '<img src="' + url + '" alt="" class="img-menu mx-auto d-block" style="height:100px; width:100px;">' +
                                ...
                                '<a class="p-2 btn-sm btn-success add_to_cart" data-id="' + val.id + '"><i class="fa fa-cart-shopping"></i> Add</a>' +
                                '</div>' +
                                '</div>' +
                                '</div>' +
                                '</div>' +
    ...
    $("body").on("submit", ".new_add_to_cart", function(e) {
        ...
        fd.append('_token', "{{ csrf_token() }}");
        $.ajax({
            url: "{{ route('admin.extra_add_to_cart') }}",
            type: "POST",
            data: fd,
            dataType: 'json',
            processData: false,
    ...
    $("body").on("click", ".show_combo_detail", function(e) {
        ...
        $.ajax({
            url: "{{ route('admin.get_combo_pack_detail') }}",
            type: "POST",
            data: fd,
            dataType: 'json',
            processData: false,
