        ...
        <div class="modal-body">
          <form class="store_properties" method="POST">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Properties Position" name="position">
              </div>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="edit_properties" method="POST">
            ...
            <div class="input-group">
              <input type="number" class="form-control" placeholder="Properties Position" name="position" id="edit_position">
            </div>
            </div>
...
<script>
  ...
  $("body").on("click", ".editPro", function(e) {
    // alert($(this).data('posid'));
    var name = $(this).data('name');
    var id = $(this).data('id');
    var posId = $(this).data('posid');
    $("#edit_cate").val(name);
    $("#edit_position").val(posId);
    $('#cateid').val(id);
