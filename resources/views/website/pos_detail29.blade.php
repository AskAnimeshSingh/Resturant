   ...
   <div class="container-fluid">
      <div class="row">
         ...
         <div class="col-md-3 mt-2">
            ...
            <h5 class="my-3" style="display: flex;justify-content: space-between;align-items: center;">Shipping Address <button style="font-size: 11px;padding: 6px 10px;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addressModal" type="button"><i class="fa fa-plus"></i> Add Address</button></h5>
            <div class="row">
               ...
               <div class="col-md-12">
                  <div class="form-check">
                     <input type="radio" class="form-check-input check1" name="address" value="{{ $item->id }}">
                     <label class="form-check-label" for="check1"> {{ $item->state  }},{{ $item->house}},{{ $item->street }} {{ $item->apartment }},{{ $item->cross_street }}</label>
                  </div>
               </div>
               ...
               if (data.products.length > 0) {
                  $.each(data.products, function(i, val) {
                     ...
                     datas += '<div class="card mb-3 bg-cart pb-3">' +
                        ...
                        '<p class="card-text mb-0"><span class="text-success"><b>$' + price + '</b>'+varient+Toppings+Properties+'</p>' +
                        '</div>' +
                        '</div>' +
